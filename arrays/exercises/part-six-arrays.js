...
//table[1] prints all of row 1, but table [1][1] prints the section of row 1 colum 1
...
element3 = ['Sodium', 'Na', 7];
element4 = ['Potassium', 'K', 39.0983];
element5 = ['Rubidium', 'Rb', 85.468];
